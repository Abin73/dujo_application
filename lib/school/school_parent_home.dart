import 'package:dujofinal/signing/dujosigning.dart';
import 'package:flutter/material.dart';

class ParentSchool extends StatefulWidget {
  const ParentSchool({super.key});

  @override
  State<ParentSchool> createState() => _ParentSchoolState();
}

class _ParentSchoolState extends State<ParentSchool> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('School Parent Home'),
      ),
